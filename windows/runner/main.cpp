                      ...
                      _In_ wchar_t *command_line, _In_ int show_command)
{
  ...
  if (SendAppLinkToInstance(L"IRC"))
  {
    return EXIT_SUCCESS;
  }

  HANDLE hMutexInstance = CreateMutex(NULL, TRUE, L"IRCMutex");
  HWND handle = FindWindowA(NULL, "IRC");
  ...
  if (GetLastError() == ERROR_ALREADY_EXISTS)
  {
    ...
    if (window.SendAppLinkToInstance(L"IRC"))
    {
      return false;
    }
  ...
  if (!window.Create(L"IRC", origin, size))
  {
    return EXIT_FAILURE;
  }
